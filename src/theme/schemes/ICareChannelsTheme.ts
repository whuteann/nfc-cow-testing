...
const themeColors = {
  primary: process.env.NEXT_PUBLIC_ENV == 'staging' ? '#FFA500' : '#006E34',
  secondary: '#FFC052',
  success: '#57CA22',
  warning: '#FFA319',
  error: '#FF1943',
  info: '#33C2FF',
  black: process.env.NEXT_PUBLIC_ENV == 'staging' ? '#593a01' : '#223354',
  white: '#ffffff',
  primaryAlt: '#000C57'
};
...
export const ICareChannelsTheme = createTheme({
  // direction: i18n.dir(),
  colors: {
    gradients: {
