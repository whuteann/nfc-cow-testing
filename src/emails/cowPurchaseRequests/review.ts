interface reviewProps {
  ...
  pricePerCow: string | number,
  calculatedPurchasePrice: string | number,
    ...
    <html>
      ...
      <body>
        <div>
          ...
          <p class="email-title">Cow Purchase Request</p>

          <div class="green-line"></div>
            <p style="font-size: 1.2em; font-weight: bold;">Purchase Details</p>
            
            <p style="margin-top: 2em; margin-bottom: 2em;">
              No of cows: ${data?.noOfCows}
            </p>
            <p style="margin-top: 2em; margin-bottom: 2em;">
              Price Per Cow: ${data?.pricePerCow}
            </p>
            <p style="margin-top: 2em; margin-bottom: 2em;">
              Total Price: ${data?.calculatedPurchasePrice}
            </p>
            <p style="margin-top: 2em; margin-bottom: 2em;">
              Reason for Purchase: ${data?.reasonForPurchase}
            </p>
