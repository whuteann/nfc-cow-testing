...
export const reject = (data: reviewProps) => {
    ...
    <html>
      ...
      <body>
        <div>
          ...
          <p class="email-title">Family Transfer Request Rejected</p>

          <div class="green-line"></div>
            <p style="font-size: 1.2em; font-weight: bold;">Family Transfer Details</p>
            
            <p style="margin-top: 2em; margin-bottom: 2em;">
              Status: ${data?.status}
            </p>
            <p style="margin-top: 2em; margin-bottom: 2em;">
              Family/Coordinator 1 Name: ${data?.family1.name}
            </p>
            <p style="margin-top: 2em; margin-bottom: 2em;">
              Family/Coordinator 2 Name: ${data?.family2.name}
            </p>
            <p style="margin-top: 2em; margin-bottom: 2em;">
