      ...
      <TableCell align="center">
        <Typography noWrap>
          <Tooltip title={t('View')} arrow>
            <IconButton onClick={() => router.push(`/dashboard/family-birth-records/${birthRecord.id}`)} color="primary">
          ...
          <Tooltip title='Logs' arrow>
            <IconButton 
            onClick={() => router.push(`/dashboard/family-birth-records/${birthRecord?.id}/logs/`)} 
            color="primary">
