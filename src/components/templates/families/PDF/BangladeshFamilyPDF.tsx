...
//family.policeStationThanaName

// Create Document Component
const BangladeshFamilyPDF = ({
  family
}: familyProps) => (
      ...
      <View style={styles.card_div}>
        <View style={styles.center_container}>
          ...
          <View style={{paddingTop: '10px', position: 'relative'}}>
            <Image style={{height: '65px', width: '65px', borderRadius: '40px', zIndex: 20}} src={family.headshot}/>
          </View>

          <View style={{width: '100%', paddingTop: '5px', paddingBottom: '5px', paddingLeft: '10px', paddingRight: '10px', maxHeight: '41px', overflow: 'hidden'}}>
            <Text style={{textAlign: 'center', fontSize: '10px', fontFamily: 'Montserrat Bold'}}>{family.name}</Text>
          </View>
        </View>
          ...
          <View style={styles.table}>
            ...
            <View style={styles.tableRow}>
              ...
              <View style={styles.tableRowTextContainer}>
                {(family.houseType === "Town")
                  ?
                  <>
                    <Text style={styles.tableRowText}>{family.flatNumber}, {family.buildingName}</Text>
                  </>
                  : 
                  <>
                    <Text style={styles.tableRowText}>{family.policeStationThanaName}</Text>
                  </>
                  }
              </View>
            </View>
            ...
            <View style={styles.tableRow}>
              ...
              <View style={styles.tableRowTextContainer}>
                <Text style={styles.tableRowText}>{(family.townVillage as any).name}</Text>
              </View>
            </View>
            ...
            <View style={styles.tableRow}>            
              ...
              <View style={styles.tableRowTextContainer}>
                <Text style={styles.tableRowText}>{(family.townVillage as any).district.name}</Text>
              </View>
            </View>
            ...
            <View style={styles.tableRow}>
              ...
              <View style={styles.tableRowTextContainer}>
                <Text style={styles.tableRowText}>{(family.townVillage as any).district.country?.name}</Text>
              </View>
            </View>
...
export default BangladeshFamilyPDF;