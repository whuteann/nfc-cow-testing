...
import { familyApprovalSchema, approvalInitialValues } from "./FamilyApprovalComponents"
...
function FamilyApprovalForm({ 
  ...
  const onSubmit = async (values: any, setSubmitting: any) => {
    return await editRequest(values, setSubmitting)
  }

  function editRequest (values: any, setSubmitting: any) {
    const id = single_family.id;
    ...
    return updateRequest(approval, id, values, async () => {
      ...
      router.push(`/dashboard/families/approvals`);
    }, (error: any) => {
      console.error(error);
    })
  };
  ...
  return (
    <Formik
      initialValues={ approvalInitialValues( single_family as any ) }
      validationSchema={ familyApprovalSchema(t) }
...
export default FamilyApprovalForm;
