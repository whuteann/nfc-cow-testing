...
const BangladeshCoordinatorPDF = ({
  coordinator
}: coordinatorProps) => (
          ...
          <View style={styles.table}>
            ...
            <View style={styles.tableRow}>
              ...
              <View style={styles.tableRowTextContainer}>
                {(coordinator.houseType === "Town")
                  ?
                  <>
                    <Text style={styles.tableRowText}>{coordinator.flatNumber}, {coordinator.buildingName}</Text>
                  </>
                  : 
                  <>
                    <Text style={styles.tableRowText}>{coordinator.policeStationThanaName}</Text>
                  </>
                  }
              </View>
            </View>
...
export default BangladeshCoordinatorPDF;