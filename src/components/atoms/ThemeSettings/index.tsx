        ...
        >
          ...
          <ThemeToggleWrapper>
            ...
            <Stack alignItems="center" spacing={2}>
              <Tooltip placement="left" title="ICareChannels" arrow>
                <ButtonWrapper
                  className={theme === 'ICareChannelsTheme' ? 'active' : ''}
                  onClick={() => {
                    changeTheme('ICareChannelsTheme');
                  }}
                >
                  {theme === 'ICareChannelsTheme' && (
                    <CheckSelected>
                      <CheckTwoToneIcon />
                    </CheckSelected>
                  )}
                  <ColorSchemeWrapper className="colorSchemeWrapper careChannels">
