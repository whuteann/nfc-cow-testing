...
function CoordinatorLogs() {
  ...
  return (
    <>
      <Head>
        <title>Cows - Coordinator log</title>
      </Head>

      <PageTitleWrapper>
        <ListHeader
          title={t("Coordinator Log")}
          description={t("List of logs")}
          showButton = {true}
          showIcon = {false}
          buttonText = 'Go Back'
          onClick={() => router.push("/dashboard/coordinators/")}
        />
      </PageTitleWrapper>
...
CoordinatorLogs.getLayout = (page: any) => <Master>{page}</Master>;
